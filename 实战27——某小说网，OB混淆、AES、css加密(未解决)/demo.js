_style = {
    setAttribute:function (res) {
        console.log('_style.setAttribute.',res)
    }
}
_head_0 = {
    getElementsByTagName:function (res) {
        console.log('_head_0.getElementsByTagName.',res)
    },
    appendChild:function (res) {
        console.log('_head_0.appendChild.',res)
    }
}
document = {
...
function getEnvs(proxyObjs) {
    for (let i = 0; i < proxyObjs.length; i++) {
      ...
      get: function(target, property, receiver) {
        console.log("方法:", "get  ", "对象:", "${proxyObjs[i]}", "  属性:", property, "  属性类型：", typeof property, ", 属性值类型：", typeof target[property]);
        return target[property];
      },
      set: function(target, property, value, receiver) {
        console.log("方法:", "set  ", "对象:", "${proxyObjs[i]}", "  属性:", property, "  属性类型：", typeof property, ", 属性值类型：", typeof target[property]);
...
proxyObjs = ['window', 'document', 'location', 'navigator', 'history', 'screen','_style','_head_0']
getEnvs(proxyObjs);
...
var _0x5281 = ['undefined', 'fromCharCode', 'bKShx', 'VkEop', 'styleSheets', 'addRule', '.context_kw', '::before', 'content:\x20\x22', 'insertRule', '::before{content:\x20\x22', 'cssRules', 'ZeroPadding', 'kHrvj', 'sigBytes', 'words', 'iHgPo', 'qEQUB', 'eXbXh', 'yLFVy', 'gMqQf', 'prototype', 'endWith', 'test', 'sa+y8KUDEUeqyUMnEi1fH1HXOuhWGcFT6wiKO4+uTv5jQ8vGMwWveWuOhI4v1uJODzwH0BH5By3Z89Mae3wH29kTfXxvH5SVEkVVq0iOpKAiSl3iJmKZ9cXI4JePjdptHUX3DxxXtEPG1S+GFlP527lOfOuD/T95ASUJ7feaK8G4c4YaEAY4/OsmnheGupw0', 'enc', 'Latin1', 'parse', 'href', 'window', 'location', 'AF336C2F3EEC9097', 'AES', 'pad', 'toString', 'Utf8', 'split', 'length', 'style', 'setAttribute', 'type', 'async', 'link', 'getElementsByTagName', 'head', 'parentNode', 'insertBefore', 'appendChild', '5|4|0|3|2|1', 'Ifqbz'];
(function (_0x30ed81, _0x2b4835) {
    var _0x3d2c81 = function (_0xcdcb97) {
        while (--_0xcdcb97) {
            _0x30ed81['push'](_0x30ed81['shift']());
        }
    };
    _0x3d2c81(++_0x2b4835);
}(_0x5281, 0x1ce));
var _0x1528 = function (_0x37242d, _0x8e7510) {
    _0x37242d = _0x37242d - 0x0;
    var _0x410996 = _0x5281[_0x37242d];
    return _0x410996;
};
