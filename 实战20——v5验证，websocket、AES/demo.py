...
def websocket_crawler(ans, token):
    try:
        # 连接到 WebSocket 服务器
        ...
        word = '{"requestId":"Req_17458947744764","command":"53031DCA131946D78173670CE98E8812","data":{"s":"轨迹","f":"c539ddb69c64cc6167f04f2b3339cfc9758884ac"}}'.replace(
            "轨迹", track)
...
def main():
    ...
    logger.debug(f"发送初始消息的内容{ans}")
    websocket_crawler(ans, token)
