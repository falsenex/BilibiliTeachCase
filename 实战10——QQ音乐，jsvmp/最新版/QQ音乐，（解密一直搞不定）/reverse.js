...
!(function () {
 ...
 params = '{"comm":{"cv":4747474,"ct":24,"format":"json","inCharset":"utf-8","outCharset":"utf-8","notice":0,"platform":"yqq.json","needNewCode":1,"uin":"1152921505038864868","g_tk_new_20200303":170927836,"g_tk":170927836},"req_1":{"module":"music.globalComment.CommentRead","method":"GetNewCommentList","param":{"BizType":1,"BizId":"535701832","LastCommentSeqNo":"1448080507404297216","PageSize":25,"PageNum":32,"FromCommentId":"","WithHot":0,"PicEnable":1,"LastTotal":12450,"LastTotalVer":"1749733074748311177"}}}'
function getSign(params) {
  return G._getSecuritySign(params)
}

function syncCgiEncrypt(params) {
  {
    let done = false;
    let result = null;
    let error = null;

    j.__cgiEncrypt(params)
      .then(data => {
        {
          result = data;
          done = true;
...
function decryptData(baseData) {
  ...
  data = base64ToArrayBuffer(baseData)
  return j.__cgiDecrypt(data)
}
console.log(syncCgiEncrypt(params))